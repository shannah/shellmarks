...
type::
A string indicating the type of widget to use for this field in the dialog.  Possible values include "text", "file", "button", and "checkbox".  If this property isn't specified it defaults to "text".
